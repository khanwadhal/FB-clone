...
\033[1;91m--> INSTAGRAM  :- YOUR
\033[1;92m--> FACEBOOK   :- YOUR
\033[1;93m--> YOUTUBE    :- YOUR
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:Pappu
	    time.sleep(2)
            loop = 'false'
        else:
...
def pilih_crack():
	...
	p.map(main, id)
	print "▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤"
	print "  Written By Pappu Bhai" #Dev:Pappu
